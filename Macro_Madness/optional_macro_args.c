...
#define PRINT_LINE_1_ARG(message) print_line(message, 0, PLAIN)
...
That is, with only one argument, `PRINT_LINE_1_ARG` will be in the 4th
position, with two arguments `PRINT_LINE_2_ARGS` will be in the 4th poisition
and `PRINT_LINE_1_ARG` in the fifth and so on.
*/
#define PRINT_LINE(...)                                         \
	COUNT_VARIABLE_ARGS(__VA_ARGS__, PRINT_LINE_3_ARGS,         \
						PRINT_LINE_2_ARGS, PRINT_LINE_1_ARG, 0) \
	(__VA_ARGS__)
